/*
Description: Test cases for dispute REJECTED for lease property (landlord wins)
...
contract('Dispute REJECTED for Lease', function (accounts) {
    ...
    it('Test 3 (Success): Validators can vote for a dispute for a lease property (3 VALIDATORS)', async () => {
        ...
        // Validator 1 reject
        let validator1VoteAccept = await leaseDisputeDAOInstance.voteOnLeaseDispute(1, 2, { from: validator1 });
        // Check if the event was emitted
        ...
        // Validator 3 approve
        let validator3VoteReject = await leaseDisputeDAOInstance.voteOnLeaseDispute(1, 1, { from: validator3 });
        // Check if the event was emitted
